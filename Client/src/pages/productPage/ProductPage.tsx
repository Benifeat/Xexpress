...
const ProductPage: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-background pt-16 z-20">
      <div className="flex w-[90%] max-w-[55%] gap-6 bg-gray-800 p-6 rounded-lg shadow-xl">
        ...
        <div className="w-1/2 flex flex-col gap-4 justify-center">
          ...
          <Popover placement="bottom" showArrow={true}>
            <PopoverTrigger>
              <Button className="flex-grow bg-red-600 text-white"  onClick={handleAddToCart}>Add to Cart</Button>
            </PopoverTrigger>
            <PopoverContent>
              <div className="px-1 py-2">
                <div className="text-small font-bold text-red-600">Item addeded to cart</div>
              </div>
            </PopoverContent>
          </Popover>
            <Button
